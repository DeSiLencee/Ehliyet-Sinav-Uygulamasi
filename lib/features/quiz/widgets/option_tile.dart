  ...
  Widget build(BuildContext context) {
    ...
    if (showResult) {
      if (isSelected) {
        ...
        tileColor = Theme.of(context).colorScheme.secondary.withOpacity(0.5); // Correct but not selected
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: showResult ? Colors.white.withOpacity(0.3) : Theme.of(context).primaryColor,
