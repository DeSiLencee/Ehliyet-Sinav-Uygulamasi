...
class FirebaseService {
  ...
  Future<List<String>> getMonths() async {
    try {
      ...
      print('Error fetching months from index: $e');
      return [];
    }
  }
  ...
  Future<List<String>> getExamsForMonth(String month) async {
    try {
      ...
      print('Error fetching exams for month $month from index: $e');
      return [];
    }
  }
  ...
  Future<List<String>> getTestListForCategory(String categoryKey) async {
    try {
      ...
      print('Error fetching test list for $categoryKey: $e');
      return [];
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getQuestionsForTest({
    ...
    try {
      ...
      print('Error fetching questions for $categoryKey/$testId: $e');
      print(stacktrace);
      return [];
    }
  }
